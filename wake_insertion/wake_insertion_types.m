...
%without the hard option: all particles inside the wake thickness will not receive velocity kick 
%realistic: nly particles that receive within the wake tichness receive no velocity kick,
