...
for file_z = 1 : length(xv_files_list_head)
    ...
    set(gca,'FontSize',16);
    set(gca,'linewidth',2);
    title({strcat('Density contrast of the 2d projection'),'of dark matter mass ar z=',Redshift},'interpreter', 'latex', 'fontsize', 20);
    hold off;
    ...
    set(gca,'FontSize',16);
    set(gca,'linewidth',2);
    title({strcat('Density contrast of the 2d projection'),'of dark matter mass at z=',Redshift},'interpreter', 'latex', 'fontsize', 20);
    hold off;
