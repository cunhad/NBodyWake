function [  ] = proj2d_cic_dm_analysis_all( root,root_data_out,root_plot_out,spec,aux_path,aux_path_data_out,aux_path_plot_out,lenght_factor,resol_factor,pivot,rot_angle,lim,data_stream,info,z_id_range)
% reads data of the 2d projections aconding to the input specifications and
% plot the result for all files in the folder

% (example) proj2d_cic_dm_analysis_all('/home/asus/Dropbox/extras/storage/graham/small_res/','/home/asus/Dropbox/extras/storage/graham/small_res/data/','/home/asus/Dropbox/extras/storage/graham/small_res/plot/','64Mpc_96c_48p_zi255_nowakem','/sample1001/','','',1,1,[0,0,0],[0,0,0],'minmax',[1,3],[0,1,2,3],'all');
% (example) proj2d_cic_dm_analysis_all('/home/asus/Dropbox/extras/storage/guillimin/','/home/asus/Dropbox/extras/storage/guillimin/data/','/home/asus/Dropbox/extras/storage/guillimin/plot/','64Mpc_1024c_512p_zi63_wakeGmu1t10m7zi31m','/sample0001/','','',1,1,[0,0,0],[0,0,0],'minmax',[1,3],[0,1,2,3],'all');
...
for rds = z_id_range
    ...
    display(filename);
    proj2d_cic_dm_analysis( root,root_data_out,root_plot_out,spec,aux_path,aux_path_data_out,aux_path_plot_out,filename,lenght_factor,resol_factor,pivot,rot_angle,lim,data_stream,info);
