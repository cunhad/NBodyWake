...
%   (example) proj2d_halos_plot_test( '/home/asus/Dropbox/extras/storage/guillimin/old/','/home/asus/Dropbox/extras/storage/guillimin/old/','/home/asus/Dropbox/extras/storage/guillimin/old/','32Mpc_96c_48p_zi63_nowakes','/','','31.000halo0.dat',1,1,[0,0,0],[0,0],'minmax')
%   (example) proj2d_halos_plot_test( '/home/asus/Dropbox/extras/storage/', '/home/asus/Dropbox/extras/storage/', '/home/asus/Dropbox/extras/storage/','40Mpc_192c_96p_zi65_nowakes','/','','0.000halo0.dat',1,1,[0,0,0],[0,0],[-1 2])
...
if(~isempty(Pos_halos))
    scatter(Pos_halos(3,:),Pos_halos(2,:),10*Radius(1,:),'r','filled');
end
