function [  ] = proj2d_dm_plot_all( root,root_data_out,root_out,spec,aux_path,aux_path_out,lenght_factor,resol_factor,pivot,rot_angle,lim )
...
for rds = 1 : length(redshift_list)
    ...
    proj2d_dm_plot( root,root_data_out,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,rot_angle,lim);
