function [ cell_bins1d_y cell_bins1d_z  Pos_halos mass_halos radius_halos count_sum_h_number count_sum_h_mass] = proj2d_halos_data_out( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,rot_angle)
...
%   (example) proj2d_halos_data_out( '/home/asus/Dropbox/extras/storage/graham/ht/', '/home/asus/Dropbox/extras/storage/graham/ht/data/','4Mpc_2048c_1024p_zi63_wakeGmu1t10m7zi10m','/sample1001/half_lin_cutoff_half_tot_pert_nvpw/','','3.000halo0.dat',1,1,[0,0,0],[0,0]);
...
[ size_box ,nc ,np ,zi ,wake_or_no_wake ,multiplicity_of_files ,Gmu ,ziw ,z ,path_file_in, ~ ,~, ~ ] = preprocessing_halo_part( root,spec,aux_path,filename,1,1);
...
% for node = 1 : length(nodes_list)
    ...
    [ size_box nc np zi wake_or_no_wake multiplicity_of_files Gmu ziw z path_file_in Pos_h mass Radiusd] = preprocessing_halo_part( root,spec,aux_path,filename,1,1);
