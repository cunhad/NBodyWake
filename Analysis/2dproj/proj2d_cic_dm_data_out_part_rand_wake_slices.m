function [ count_sum] = proj2d_cic_dm_data_out_part_rand_wake_slices( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,data_stream,particl_part,numb_rand,slice)
