function [ count_sum] = proj2d_cic_dm_data_out_part( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,rot_angle,data_stream,particl_part)
