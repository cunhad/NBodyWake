function [  ] = proj2d_cic_dm_analysis( root,root_data_out,root_plot_out,spec,aux_path,aux_path_data_out,aux_path_plot_out,filename,lenght_factor,resol_factor,pivot,rot_angle,lim,data_stream,info)
% reads data of the 2d projections aconding to the input specifications and plot the result

%(example) proj2d_cic_dm_analysis('/home/asus/Dropbox/extras/storage/graham/small_res/','/home/asus/Dropbox/extras/storage/graham/small_res/data/','/home/asus/Dropbox/extras/storage/graham/small_res/plot/','64Mpc_96c_48p_zi255_nowakem','/sample1001/','','','0.000xv0.dat',1,1,[0,0,0],[0,0,0],'minmax',[1,3],[0,1,2,3]);
%(example) proj2d_cic_dm_analysis('/home/asus/Dropbox/extras/storage/graham/small_res/','/home/asus/Dropbox/extras/storage/graham/small_res/data/','/home/asus/Dropbox/extras/storage/graham/small_res/plot/','64Mpc_256c_128p_zi63_nowakem','/sample2001/','','','10.000xv0.dat',1,1,[0,0,0],[0,0,0],[-1 2],[1,3],[0,1,2,3]);
%(example) proj2d_cic_dm_analysis('/home/asus/Dropbox/extras/storage/guillimin/','/home/asus/Dropbox/extras/storage/guillimin/data/','/home/asus/Dropbox/extras/storage/guillimin/plot/','64Mpc_1024c_512p_zi63_wakeGmu1t10m7zi31m','/sample0001/','','','10.000xv0.dat',1,1,[0,0,0],[0,0],'minmax',[1,3],[0,1,2,3]);
...
if ismember(0,data_stream)    
   [ ~,~,proj2d] = proj2d_cic_dm_data_out( root,root_data_out,spec,aux_path,aux_path_data_out,filename,lenght_factor,resol_factor,pivot,rot_angle,0);
else    
    ...
    if ismember(2,data_stream)
        if ismember(3,data_stream)
            proj2d_cic_dm_data_out( root,root_data_out,spec,aux_path,aux_path_data_out,filename,lenght_factor,resol_factor,pivot,rot_angle,2);
        end
    ...
    if ismember(1,data_stream)
        if ismember(3,data_stream)
            proj2d_cic_dm_data_out( root,root_data_out,spec,aux_path,aux_path_data_out,filename,lenght_factor,resol_factor,pivot,rot_angle,1);
        end
