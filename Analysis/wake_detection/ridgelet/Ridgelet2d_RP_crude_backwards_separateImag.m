function [ X_rec_phase ] = Ridgelet2d_RP_crude_backwards_separateImag( Radon_hor_, Radon_vert_ )
...
for r=1:ncx
    for t=1:ncy+(1-is_odd_ncy)
        Radon_hor_phase_rec(t,r)=(exp(1i*pi*(r-1)*(1-is_odd_ncx/ncx)))*Radon_hor_(t,r);
    end
end

for t=1:ncx+(1-is_odd_ncx)
    for r=1:ncy
        Radon_vert_phase_rec(t,r)=(exp(1i*pi*(r-1)*(1-is_odd_ncy/ncy)))*Radon_vert_(t,r);
    end
end
