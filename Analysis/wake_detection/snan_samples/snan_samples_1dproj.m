function [   ] = snan_samples_1dproj(root,root_snan_in,root_snan_out,spec,aux_path,aux_path_snan_in,aux_path_snan_out,lenght_factor,resol_factor,pivot,rot_angle,z_id_range,sample_id_range,info,analysis)

%reads the data from proj1d_dm_analysis for the signal to noise analysis
%and creates the corresponding figures

%(example) snan_smaples_1dproj('/home/asus/Dropbox/extras/storage/guillimin/test/','/home/asus/Dropbox/extras/storage/guillimin/test/snan/','/home/asus/Dropbox/extras/storage/guillimin/test/snan_out/','64Mpc_96c_48p_zi63_nowakem','/sample0001/','','',1,1,[0,0,0],[0,0],'all','all',[1,2,3],[1,2,3]);
...
if ismember(1,analysis)    
    if ismember(1,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_eachSample_manyRed/1d_dm_1')));
    end    
    if ismember(2,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_eachSample_manyRed/','1d_dm_2')));
    end
    if ismember(3,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_eachSample_manyRed/','1d_dm_3')));
    end    
end

if ismember(2,analysis)    
    if ismember(1,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_eachRed/1d_dm_1')));
    end  
    if ismember(2,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_eachRed/1d_dm_2')));
    end      
    if ismember(3,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_eachRed/1d_dm_3')));
    end  
end

if ismember(3,analysis)    
    if ismember(1,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_manyRed/1d_dm_1')));
    end  
    if ismember(2,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_manyRed/1d_dm_2')));
    end      
    if ismember(3,info)
        mkdir(strcat(path_samples_out,strcat('/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/','/snan_manySample_manyRed/1d_dm_3')));
    end  
end
...
%             data1(:,2:4)=num2cell(squeeze(snan_data(:,sample,:)));
            ...
            saveas(fig1,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_eachSample_manyRed/1d_dm_1'),'/snan_eachSample_manyRed_',char(sample_list(sample))),'.png'));
        end
...
%             data1(:,2:4)=num2cell(squeeze(snan_data(:,sample,:)));
            ...
            saveas(fig2,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_eachSample_manyRed/1d_dm_2'),'/snan_eachSample_manyRed_',char(sample_list(sample))),'.png'));
...
%             data1(:,2:4)=num2cell(squeeze(snan_data(:,sample,:)));
            ...
            saveas(fig3,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_eachSample_manyRed/1d_dm_3'),'/snan_eachSample_manyRed_',char(sample_list(sample))),'.png'));
...
%             part(:,2:4)=num2cell(squeeze(snan_data(:,sample,:)));
            ...
            t.Position(3:4) = t.Extent(3:4);
            set(gcf, 'Position', [0 0 t.Position(3)+30 t.Position(4)+30]);
            saveas(fig1,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_eachRed/1d_dm_1'),'/snan_manySample_eachRed',num2str(str2num(char(redshift_list(rds))))),'.png'));
        end 
        if ismember(2,info)            
            fig2=figure('Visible', 'off');
            ax2 = axes('Position',[0 0 1 1],'Visible','off');
            ...
            txt=text(0.1,0.8,tit);
            set(txt,'Parent',ax2,'interpreter', 'latex','fontsize', 20);
            saveas(fig2,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_eachRed/1d_dm_2'),'/snan_manySample_eachRed',num2str(str2num(char(redshift_list(rds))))),'.png'));
        end
        if ismember(3,info)                       
            fig2=figure('Visible', 'off');
            ax2 = axes('Position',[0 0 1 1],'Visible','off');
            ...
            txt2=text(0.65,0.5,descr);
            set(txt2,'Parent',ax2,'interpreter', 'latex','fontsize', 10);              
            saveas(fig2,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_eachRed/1d_dm_3'),'/snan_manySample_eachRed',num2str(str2num(char(redshift_list(rds))))),'.png'));
        end        
        rds_recount=rds_recount+1;
    end    
end
...
if ismember(3,analysis)
    ...
    if ismember(1,info)
        ...
        t.Position(3:4) = t.Extent(3:4);
        set(gcf, 'Position', [0 0 t.Position(3)+30 t.Position(4)+30]);
        saveas(fig1,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_manyRed/1d_dm_1'),'/snan_manySample_manyRed'),'.png'));
    end
    if ismember(2,info)
        ...
        txt=text(0.1,0.8,tit);
        set(txt,'Parent',ax2,'interpreter', 'latex','fontsize', 20);
        saveas(fig1,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_manyRed/1d_dm_2'),'/snan_manySample_manyRed'),'.png'));
    end
    if ismember(3,info)
        fig1=figure('Visible', 'off');
        ax2 = axes('Position',[0 0 1 1],'Visible','off');
        ...
        descr = {strcat('$G\mu = $ ',num2str(Gmu,'%.1E'));
            ...
            set(txt2,'Parent',ax2,'interpreter', 'latex','fontsize', 10);  
        saveas(fig1,strcat(strcat(path_samples_out,'/',num2str(lenght_factor),'lf_',num2str(resol_factor),'rf_',strcat(num2str(pivot(1)),'-',num2str(pivot(2)),'-',num2str(pivot(3))),'pv_',strcat(num2str(rot_angle(1)),'-',num2str(rot_angle(2))),'ra','/',strcat('/snan_manySample_manyRed/1d_dm_3'),'/snan_manySample_manyRed'),'.png'));
    end
end
