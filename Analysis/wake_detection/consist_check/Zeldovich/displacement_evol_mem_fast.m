function [  ] = displacement_evol_mem_fast( root,root_data_out,root_plot_out,spec,aux_path )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% (example) []=displacement_evol_mem_fast( '/home/asus/Dropbox/extras/storage/graham/small_res/','/home/asus/Dropbox/extras/storage/graham/small_res/data/','/home/asus/Dropbox/extras/storage/graham/small_res/plot/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/')
...
%         displacement=pid_posZ_w(:,2)-pid_posZ(find(sorted_w_(:)==sorted_),2);
        ...
        for idx=1:length(sorted_w_(:))
            ...
            if ~isempty(part_z_nw)
                ...
                pos_z_w_list = [ pos_z_w_list part_z_w ];
                
                if (part_z_w-part_z_nw)>nc/2
                    displac_list=[displac_list part_z_w-part_z_nw-nc];
                elseif  (part_z_w-part_z_nw)<-nc/2
                    displac_list=[displac_list part_z_w-part_z_nw+nc];
                else
                    displac_list=[displac_list part_z_w-part_z_nw];
                end
