function [  ] = dwavelets_1d_dm_analysis_all( root,root_data_out,root_plot_out,root_snan_out,spec,aux_path,aux_path_data_out,aux_path_plot_out,aux_path_snan_out,lenght_factor,resol_factor,pivot,rot_angle,level_window,data_stream,info,analysis,z_id_range,dwbasis)
...
for rds = z_id_range
    ...
    dwavelets_1d_dm_analysis( root,root_data_out,root_plot_out,root_snan_out,spec,aux_path,aux_path_data_out,aux_path_plot_out,aux_path_snan_out,filename,lenght_factor,resol_factor,pivot,rot_angle,level_window,data_stream,info,analysis,dwbasis);
