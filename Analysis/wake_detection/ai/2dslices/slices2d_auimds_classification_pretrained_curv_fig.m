...
%             filename_nowake=strcat('',specs_path_list,'/',string(sample_list(sample)),'/data/1lf_1rf_0-0-0pv_1.5708-0-0ra/2dproj/dm/2d_curvfilt/',ch,filename,num2str(slice_id),'_curvfilt2a3d','.bin');
            filename_nowake=strcat('',specs_path_list,'/',string(sample_list(sample)),'/data/1lf_1rf_0-0-0pv_1.5708-0-0ra/2dproj/dm/2a3d_curvfilt/',ch,filename,num2str(slice_id),'_fcurvfilt2a3d3col','.png');
...
auimdsTrain = augmentedImageDatastore([224 224],imdsTrain,'DataAugmentation',imageAugmenter);
auimdsValidation = augmentedImageDatastore([224 224],imdsValidation,'DataAugmentation',imageAugmenter);
% 
...
% auimdsTrain = augmentedImageDatastore([227 227],imdsTrain,'DataAugmentation',imageAugmenter);
% auimdsValidation = augmentedImageDatastore([227 227],imdsValidation,'DataAugmentation',imageAugmenter);
