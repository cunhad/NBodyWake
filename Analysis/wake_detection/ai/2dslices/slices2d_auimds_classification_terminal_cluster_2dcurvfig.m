function [  ] = slices2d_auimds_classification_terminal_cluster_2dcurvfig()
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% filename='_col_2dproj_z3_data_sl';
% filename='_col_2dproj_2dcurv_z3_visual_sl';
filename='_2dproj_2dcurv_z3_visual_sl';
...
%         list_of_angle_paths=dir(char(strcat(specs_path_list,'/',string(sample_list(sample)),'/data/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/anglid_*')));
        list_of_angle_paths=dir(char(strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_2dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/anglid_*')));
...
%                 %             fclose(fid);
                ...
                path1=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_2dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/');
...
%                 path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_2dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'_log_fig.png');
                path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_2dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'.png');
