...
%                 %             fclose(fid);
                ...
                path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/data/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'_log_fig.png');
