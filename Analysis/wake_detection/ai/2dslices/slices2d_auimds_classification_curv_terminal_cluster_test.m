function [  ] = slices2d_auimds_classification_curv_terminal_cluster_test()
...
%                 %             fclose(fid);
                ...
                path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/data_2d_filt_slices/1lf_1rf','/NSIDE_',num2str(NSIDE),'/anglid_',num2str(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'_log_fig.bin');
