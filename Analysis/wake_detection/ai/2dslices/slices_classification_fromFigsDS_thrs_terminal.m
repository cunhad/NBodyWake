function [] = slices_classification_fromFigsDS_thrs_terminal()
...
% input vars
path_soft_links = '/scratch/cunhad/data_cps32_512_hpx_2d_NSIDE4_figs_thr30';
...
YPredTot = classify(net,imdsTot,'MiniBatchSize',miniBatchSize);
YValidationTot = imdsTot.Label;
