function [  ] = slices2d_auimds_class_ter_clust_3dcurv_deep_anglRang()
...
% specs_path_list_wake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps32_512_hpxNSIDE4_2dclaral1lr1na1024_and_3dparclaral1lr1_visual_fig/4Mpc_2048c_1024p_zi63_wakeGmu4t10m8zi10m'
...
%                 path1=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_3dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/');
                path1=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_depth_',string(depth),'_3dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/');
...
%                 path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_2dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'_log_fig.png');
                path_in=strcat(specs_path_list,'/',string(sample_list(sample)),'/visual_depth_',string(depth),'_3dfilt/1lf_0.5rf','/NSIDE_',num2str(NSIDE),'/',list_of_angle_paths(angle_id),'/',string(path2),'/2dproj/dm/',ch,filename,num2str(slice_id),'.png');
