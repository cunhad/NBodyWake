...
% % root_data_2d_out='/home/asus/Dropbox/extras/storage/graham/ht/data_cps128_1024_3dcurv_s5lv3_data/';
root_data_2d_out='';
root_anali_2d_out='/home/asus/Dropbox/extras/storage/graham/ht/data_cps128_1024_3dcurv_s5lv3_anali/';
root_visual_2d='/home/asus/Dropbox/extras/storage/graham/ht/data_cps128_1024_3dcurv_s5lv3_visual/';
...
visual_type=[1:2]; %if 1, shows the 2d proj; if 2 shows the ridgelet transformation
 visual_in_or_out=[1]; %if 1 do visualization of the input, if 2 of the output
 partition2d=4;
 sum_depth=16;
...
map_3d_slices_filt3d=zeros(nc_anal2d,nc_anal2d,slices);
...
for partition_x=0:partition2d-1
    for partition_y=0:partition2d-1
        ...
        C_aux=map_3d_slices((partition_x)*nc_anal2d/partition2d+1:(partition_x)*nc_anal2d/partition2d+nc_anal2d/partition2d,(partition_y)*nc_anal2d/partition2d+1:(partition_y)*nc_anal2d/partition2d+nc_anal2d/partition2d,1:slices);
        ...
        map_3d_slices_filt3d((partition_x)*nc_anal2d/partition2d+1:(partition_x)*nc_anal2d/partition2d+nc_anal2d/partition2d,(partition_y)*nc_anal2d/partition2d+1:(partition_y)*nc_anal2d/partition2d+nc_anal2d/partition2d,1:slices) = real(fdct3d_inverse(Ct));
