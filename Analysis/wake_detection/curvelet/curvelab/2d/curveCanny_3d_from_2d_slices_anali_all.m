...
filename='2.000xv0.dat'; GMU_pre=4;
slices=16;
nc=1024;
sum_depth=4;
L_box=8;
% root_anali_2d_in=strcat('/home/asus/Dropbox/extras/storage/graham/ht/data_cps',num2str(slices),'_',num2str(nc),'_2dclara-l3lr2na1024_to_3dparclar-l1lr2_anali/');
