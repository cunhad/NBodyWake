function [ anali,sample_id_range_nw,sample_id_range_w ] = curve2d_show_slices_minimal_nor_locangreal(  )
...
display_slice_nw{find(sample_id_range_nw==7)}=[8];
display_slice_w{find(sample_id_range_w==7)}=[8];
...
% 
% 
% [ anali,sample_id_range_nw,sample_id_range_w ] = curve2d_show_slices_minimal_nor_locangreal(  )
% 
% 
