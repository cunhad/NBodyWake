...
for partition=0:partition3rd-1
    for partition_x=0:partition2d-1
        for partition_y=0:partition2d-1
            ...
            anali_curv(4,partition+1,partition_x+1,partition_y+1,:)=curv_4(:);
            anali_curv(5,partition+1,partition_x+1,partition_y+1,:)=curv_5(:);
            
        end
    end
end

anali3_curv1(:)=anali_curv(1,:,:,:,:);
anali3_curv2(:)=anali_curv(2,:,:,:,:);
anali3_curv3(:)=anali_curv(3,:,:,:,:);
anali3_curv4(:)=anali_curv(4,:,:,:,:);
anali3_curv5(:)=anali_curv(5,:,:,:,:);
