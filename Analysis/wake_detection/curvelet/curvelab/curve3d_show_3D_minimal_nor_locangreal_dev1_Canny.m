function [ anali,anali_curv_mom,anali3,anali3_curv_mom,sample_id_range_nw,sample_id_range_w ] = curve3d_show_slices_minimal_nor_locangreal_dev1_segCanny(  )
...
specs_path_list_nowake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps128_128/2Mpc_2048c_1024p_zi63_nowakem'
...
specs_path_list_wake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps128_128/2Mpc_2048c_1024p_zi63_wakeGmu1t10m7zi10m'
...
%     for sample = 1:2
        ...
        map_3d_slices_original=zeros(nc,nc,slices);
        ...
        for slice_id=1:slices
            ...
            filename_nowake=strcat('',specs_path_list,'/',string(sample_list(sample)),'/data/1lf_0.125rf_0-0-0pv_1.5708-0-0ra/2dproj/dm/',ch,filename,num2str(slice_id),'.bin')
