function [ anali_sum2,sample_id_range_nw,sample_id_range_w ] = curve3d_show_slices(  )
...
%                 figure; imagesc((size_mpc/nc)*[1:nc],(size_mpc/1024)*[1:nc],map_3d_slices_filt2a3d(:,:,slice_id)); colorbar; axis('image');
                figure; imagesc(0:180,(size_mpc/new_nc)*[1:new_nc],R_nor_filt);colorbar;
...
% [ anali,anali_sum,anali_sum2 ] = curve3d_show_slices(  )
% [ anali_sum2,sample_id_range_nw,sample_id_range_w ] = curve3d_show_slices(  )
% 
% 
