function [ anali,signal,equator_phi ] = slices_curv_2a3d_locangrealCanny_eachslice_all_groups( )
...
% specs_path_list_nowake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps32_1024_hpxNSIDE4_2dclaral1lr1na1024_and_3dparclaraCannyl1lr1_anali_hpx_Sa4t1/16Mpc_2048c_1024p_zi63_nowakem'
specs_path_list_nowake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps32_512_hpxNSIDE4_2dclaral1lr1na1024_and_3dparclaral1lr1_anali_Sa4t3/4Mpc_2048c_1024p_zi63_nowakem'
...
% specs_path_list_wake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps32_512_hpxNSIDE4_2dclaral1lr1na1024_and_3dparclaral1lr1_anali_Sa4t3/4Mpc_2048c_1024p_zi63_wakeGmu4t10m8zi10m'
specs_path_list_wake='/home/asus/Dropbox/extras/storage/graham/ht/data_cps32_512_hpxNSIDE4_wake_2dclaral1lr1na1024_and_3dparclaral1lr1_anali_Sa4t3/4Mpc_2048c_1024p_zi63_wakeGmu4t10m8zi10m'
...
N_slices_probe=N_slices;        %for L_box=4Mpc/h,N=96=6*N_side^2,samples=10, we would have ~0.65*N_slices per hubble 
n_strin_per_hubble=1;

thresh=max(signal_sample_nw(:))
% thresh=532;
outlier_w_count=sum(signal_sample_w>thresh,2);
sum(signal_sample_w>thresh,2)'
...
%do various histogram, each for one simulation
figure;
histogram(signal_sample_nw(1,:),'BinWidth',1);
hold on
for i=2:10    
    histogram(signal_sample_nw(i,:),'BinWidth',1);
end
set(gca, 'YScale', 'log')
