...
%(example)  [ anali] = slices_curv_2d_all('/home/asus/Dropbox/extras/storage/graham/small_res/','/home/asus/Dropbox/extras/storage/graham/small_res/anali/','/home/asus/Dropbox/extras/storage/graham/small_res/anali_hpx/','64Mpc_256c_128p_zi63_nowakem','/sample2001/','','10.000xv0.dat',1,1,2,2 );
...
tot_anali_path_out=char(strcat(root_2d_anali_hpx,spec,spec,aux_path,'anali/',aux_path_out,num2str(lenght_factor),'lf_',num2str(resol_factor),'rf','/NSIDE_',num2str(NSIDE),'/slices_curv_2d/hpx/'))
mkdir(tot_anali_path_out);
        
tot_anali_data_path_out=char(strcat(root_2d_anali_hpx,spec,spec,aux_path,'data_anali/',aux_path_out,num2str(lenght_factor),'lf_',num2str(resol_factor),'rf','/NSIDE_',num2str(NSIDE),'/slices_curv_2d/hpx/'))
