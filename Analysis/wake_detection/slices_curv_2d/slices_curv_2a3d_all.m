function [ anali,signal,equator_phi ] = slices_curv_2a3d_all( root,root_anali_2d_in,root_2d_anali_hpx,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,slice,NSIDE)
...
for angle_id=1:N_angles
    ...
    aux=dlmread(strcat(path_in,'_',num2str(find(str2num(char(redshift_list))==z_glob)),'_2dproj_z',num2str(z_glob),'_data_2a3dcurv_sl','.txt'));
