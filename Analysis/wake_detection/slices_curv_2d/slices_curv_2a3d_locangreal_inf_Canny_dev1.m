...
% visual_type=[1:2:3:4];        %if 1, shows the 2d proj; %if 2 shows the ridgelet transformation    %if 3 does everything also for the depth %if 4 does also canny on #2 below                         
% visual_in_or_out=[1:4]; %if 1 do visualization of the input,%  if 2 of the 2d_filtered    %  if 3 of the 3d filtered                            
% %  visual_in_or_out=[2];
...
% root_data_2d_anali_out='/home/asus/Dropbox/extras/storage/graham/ht/data_tst_anali1Canny/';
% root_visual_2d='/home/asus/Dropbox/extras/storage/graham/ht/data_tst_anali_visual1Canny/';
...
% visual_in_or_out=[1:3]; %if 1 do visualization of the input,%  if 2 of
% the 2d_filtered    %  if 3 of the 3d filtered %if 3 does also canny from #3
% %  visual_in_or_out=[2];
% stage=[3];              % for doing the 3d
% %  info=[0,1,2]             %0,for just simplest visualisation
%                             %1 with minimal information
