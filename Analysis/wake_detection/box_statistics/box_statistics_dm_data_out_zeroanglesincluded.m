function [ proj1d_angles] = box_statistics_dm_data_out_zeroanglesincluded( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,part,num_cores,data_stream,cutoff)
...
%(example)  [proj1d_angles] = box_statistics_dm_data_out_zeroanglesincluded('/home/asus/Dropbox/extras/storage/graham/small_res/', '/home/asus/Dropbox/extras/storage/graham/small_res/box_stat/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/','','10.000xv0.dat',2,2,[0,0,0],2,1,4,[1,2],4);
...
[x(1,:),x(2,:),x(3,:)] = sph2cart(angles(2,:),angles(1,:),1);
...
[angles(2,:),angles(1,:),~] = cart2sph(x(1,:),x(2,:),x(3,:));
