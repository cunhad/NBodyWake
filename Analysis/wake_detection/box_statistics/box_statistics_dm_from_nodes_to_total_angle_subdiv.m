...
ind_ang_list=cellfun(@(x) x(7+cell2mat(strfind(sorted_files_list3(1:1), '_subang')):-1+cell2mat(strfind(sorted_files_list3(1:1), '_NSIDE'))),sorted_files_list2,'UniformOutput', false);
