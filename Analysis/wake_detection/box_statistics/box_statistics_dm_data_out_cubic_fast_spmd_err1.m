function [ proj1d_angles ] = box_statistics_dm_data_out_cubic_fast_spmd_err1( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,part_p,num_cores,data_stream,level_window,dwbasis)
...
%(example)  [proj1d_angles] = box_statistics_dm_data_out_cubic_fast_spmd_err1('/home/asus/Dropbox/extras/storage/graham/small_res/', '/home/asus/Dropbox/extras/storage/graham/small_res/box_stat_cubic_fast/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/','','10.000xv0.dat',2,1,[0,0,0],2,1,4,4,[1,2],[1],'sym6');
...
angles_dist=distributed(angles_hpx);
...
for part_id = 1  :   part_p
    ...
    %remove particles that are outside the analysis box
        ...
        histogr_1d_angles=distributed(zeros(length(bins)-1,number_of_angle_nuple_hpx));
...
%             histogr_1d_angles1=zeros(length(bins)-1,number_of_angle_nuple_hpx);
            ...
            for i=drange(1:number_of_angle_nuple_hpx)
                ...
                histogr_1d_angles(:,i)=histcounts(dz,bins);
...
%             histogr_1d_angles=histogr_1d_angles+histogr_1d_angles1;
        ...
        proj1d_angles=proj1d_angles+gather(histogr_1d_angles);
