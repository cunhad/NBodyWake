function [ proj1d_angles,max_amplitude_filtered_proj1d_angles ] = box_statistics_dm_data_out_cubic_fast_ap_cic( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,part_p,angle_p,num_cores,data_stream,level_window,dwbasis)
...
for part_id = 1  :   part_p
    ...
    for cor=1:angle_p
        ...
        parfor i=angl_ind_start:angl_ind_end
            ...
            dz=dz+(np*resol_factor/2)+pivot(3);
...
[v f] = createCube; v = (v-[0.5 0.5 0.5])*np/lenght_factor ;
