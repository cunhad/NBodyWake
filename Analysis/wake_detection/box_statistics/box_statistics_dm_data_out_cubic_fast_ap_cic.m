function [ proj1d_angles,filtered_proj1d_angles ] = box_statistics_dm_data_out_cubic_fast_ap_cic( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,part_p,angle_p,num_cores,data_stream,level_window,dwbasis)
...
%(example)  [proj1d_angles] = box_statistics_dm_data_out_cubic_fast_ap_cic('/home/asus/Dropbox/extras/storage/graham/small_res/', '/home/asus/Dropbox/extras/storage/graham/small_res/box_stat_cubic_fast_ap_cic/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/','','10.000xv0.dat',2,1,[0,0,0],2,1,4,4,[1,2],[1],'sym6');
...
% else
    bins=[+8-np*resol_factor/(2*lenght_factor):(np*resol_factor/(2*lenght_factor))-8];
% end
...
for part_id = 1  :   part_p
    ...
    for cor=1:angle_p
        ...
        %         dz=zeros((np*resol_factor/lenght_factor)
