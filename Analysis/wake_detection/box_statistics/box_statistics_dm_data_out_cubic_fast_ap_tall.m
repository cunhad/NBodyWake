function [ proj1d_angles,filtered_proj1d_angles ] = box_statistics_dm_data_out_cubic_fast_ap_tall( root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,angle_p,angle_id,num_cores,data_stream,level_window,dwbasis)
...
%(example)  [proj1d_angles] = box_statistics_dm_data_out_cubic_fast_ap_tall('/home/asus/Dropbox/extras/storage/graham/small_res/', '/home/asus/Dropbox/extras/storage/graham/small_res/box_stat_cubic_fast/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/','','10.000xv0.dat',2,1,[0,0,0],64,1,1,4,[1,2],[1],'sym6');
...
nz=[sin(thetas.Var1).*cos(phis.Var1) sin(thetas.Var1).*sin(phis.Var1) cos(thetas.Var1)];



parfor angl=1:angl_chuck_size
    dz=nz(angl,1).*Pos.Var1+nz(angl,2).*Pos.Var2+nz(angl,3).*Pos.Var3;
