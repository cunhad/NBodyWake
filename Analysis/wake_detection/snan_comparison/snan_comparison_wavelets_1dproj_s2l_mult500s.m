    function [ snan_data_nowake snan_data_wake] = snan_comparison_wavelets_1dproj_s2l_mult500s(root,root_snan_in,root_snan_comp_out,aux_path_snan_in,aux_path_snan_comp_out,lenght_factor,resol_factor,pivot,NSIDE,part_in,angle_part,angle_p,num_cores,level_window1d,quantity_type,dm_or_dc,dwbasis,n_angles_1d,n_max)

%reads the data from proj1d_dm_analysis for the signal to noise analysis
%and creates the corresponding figures

% (example) snan_comparison_wavelets_1dproj_s2l_mult500s('/home/asus/Dropbox/extras/storage/guillimin/','/home/asus/Dropbox/extras/storage/guillimin/box_snan_s2l/','/home/asus/Dropbox/extras/storage/guillimin/box_snan_s2l_comparizon/','','',2,1,[0,0,0],1024,16,2,8,32,[1],1,1,'sym6',32,3);
% (example) snan_comparison_wavelets_1dproj_s2l_mult500s('/home/asus/Dropbox/extras/storage/guillimin/','/home/asus/Dropbox/extras/storage/guillimin/box_snan_types_cic_diff_loc/','/home/asus/Dropbox/extras/storage/guillimin/box_snan_s2l_comparizon/','','',2,1,[0,0,0],1024,16,2,8,32,[1],1,1,'sym6',32,3);
% (example) snan_comparison_wavelets_1dproj_s2l_mult500s('/home/asus/Dropbox/extras/storage/graham/','/home/asus/Dropbox/extras/storage/graham/snan_gra64/','/home/asus/Dropbox/extras/storage/guillimin/snan_gra64_comparizon/','','',1,2,[0,0,0],[0,0],0.4,'all');
...
%     hold(ax_max_clgposdt,'on');
    ...
    max_nowake(sample)=pk(2)*pk(3)*pk(4)*pk(5)*pk(6)*pk(7)*pk(8)*pk(9)*pk(10)*pk(11)*pk(12)/(std_lvs(2)*std_lvs(3)*std_lvs(4)*std_lvs(5)*std_lvs(6)*std_lvs(7)*std_lvs(8)*std_lvs(9)*std_lvs(10)*std_lvs(11)*std_lvs(12));;
    
    p_nw_max{sample}= scatter(ax_max_clgposdt,1,max_nowake(sample),'b');
    hold(ax_max_clgposdt,'on');
...
%     ax_clgposdt=axes(fig_clgposdt);
    ...
    %     hold on;
    max_wake(sample)=pk(2)*pk(3)*pk(4)*pk(5)*pk(6)*pk(7)*pk(8)*pk(9)*pk(10)*pk(11)*pk(12)/(std_lvs(2)*std_lvs(3)*std_lvs(4)*std_lvs(5)*std_lvs(6)*std_lvs(7)*std_lvs(8)*std_lvs(9)*std_lvs(10)*std_lvs(11)*std_lvs(12));;
    
    p_w_max{sample}=   scatter(ax_max_clgposdt,1,max_wake(sample),'r');
    hold(ax_max_clgposdt,'on');
    ...
    set(ax_max_clgposdt,'YScale','log');
