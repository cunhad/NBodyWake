function [ peak ] = snan_comparison_wavelets_1dproj_withnull(root,root_snan_in,root_snan_out,aux_path_snan_in,aux_path_snan_out,lenght_factor,resol_factor,pivot,rot_angle,cutoff,z_id_range,id_specs,info,analysis)

%reads the data from proj1d_dm_analysis for the signal to noise analysis
%and creates the corresponding figures

%(example) snan_comparison_wavelets_1dproj_withnull('/home/asus/Dropbox/extras/storage/guillimin/','/home/asus/Dropbox/extras/storage/guillimin/snan/','/home/asus/Dropbox/extras/storage/guillimin/snan_comparizon/','','',1,1,[0,0,0],[0,0],0.8,'all','all',[1,2,3],[1,2,3]);
...
%     for rds = z_id_range
        ...
        scatter(ax1,(redshift_array+1).^-1,transpose(snan_data(:,1,1)));
         hold(ax1,'on');
