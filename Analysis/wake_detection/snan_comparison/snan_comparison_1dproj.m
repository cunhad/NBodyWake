function [ specs_list ] = snan_comparison_1dproj(root_snan_in,root_snan_out,aux_path_snan_in,aux_path_snan_out,lenght_factor,resol_factor,pivot,rot_angle,z_id_range,id_specs,info,analysis)

%reads the data from proj1d_dm_analysis for the signal to noise analysis
%and creates the corresponding figures

%(example) snan_comparison_1dproj('/home/asus/Dropbox/extras/storage/graham/small_res/snan/','/home/asus/Dropbox/extras/storage/graham/small_res/snan_out/','','',1,1,[0,0,0],[0,0],'all','all',[1,2,3],[1,2,3]);
