function [ size_box, nc, np, zi, wake_or_no_wake ,multiplicity_of_files ,Gmu ,ziw ,z, path_file_in, Pos,N_part  ] = preprocessing_part_aux( path,spec,aux_path,filename,lenght_factor,pivot,part,part_id)
...
%(example) [ size_box, nc, np, zi, wake_or_no_wake ,multiplicity_of_files ,Gmu ,ziw ,z, path_file_in, Pos ] = preprocessing_part_aux( '/home/asus/Dropbox/extras/storage/graham/small_res/','64Mpc_96c_48p_zi255_nowakem','/sample1001/','0.000xv0.dat',8,1);
...
%check if particles are inside the volume
