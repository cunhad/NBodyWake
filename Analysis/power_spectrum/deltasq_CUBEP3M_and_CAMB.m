function [  ] = deltasq_CUBEP3M_and_CAMB( root,root_out,spec,aux_path,aux_path_out )

%(example) deltasq_CUBEP3M_and_CAMB('/home/asus/Dropbox/extras/storage/','/home/asus/Dropbox/extras/storage/','40Mpc_240c_120p_zi65_nowakes','/','' );
...
path_out=strcat(strcat(root_out,spec,aux_path),'plot/',aux_path_out,num2str(1),'lf_',num2str(1),'rf_',strcat(num2str(0),'-',num2str(0),'-',num2str(0)),'pv_',strcat(num2str(0),'-',num2str(0)),'ra','/','power_spectrum/deltasq_CAMBcomp/');
mkdir(strcat(root_out,spec,aux_path),strcat('plot/',aux_path_out,num2str(1),'lf_',num2str(1),'rf_',strcat(num2str(0),'-',num2str(0),'-',num2str(0)),'pv_',strcat(num2str(0),'-',num2str(0)),'ra','/','power_spectrum/deltasq_CAMBcomp/'));


path_file_out=strcat(path_out,'_',num2str(k),'_deltasq_CAMBcomp_z',z,'.jpg');
