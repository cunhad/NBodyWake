function [  root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,particl_part,angle_part,angle_p,num_cores,data_stream,level_window,dwbasis ] = dm_box_cubic_fast_files_to_file_boost(  root,root_out,spec,aux_path,aux_path_out,filename,lenght_factor,resol_factor,pivot,NSIDE,particl_part,angle_part,angle_p,num_cores,data_stream,level_window,dwbasis )
...
%(example)  [] = dm_box_cubic_fast_files_to_file_boost('/home/asus/Dropbox/extras/storage/graham/small_res/', '/home/asus/Dropbox/extras/storage/graham/small_res/box_stat_cubic_fast/','64Mpc_96c_48p_zi255_wakeGmu5t10m6zi63m','/sample1001/','','10.000xv0.dat',2,1,[0,0,0],64,1,1,4,4,[1,2],[1],'sym6');
% 
% 
...
% %            
            phi_indice_inverse=angl_to_pix(angles_hpx(1,angl),angles_hpx(2,angl),NSIDE);
