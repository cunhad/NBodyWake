...
if ~ismember(0,data_stream)
    ...
    if ismember(1,data_stream)
        ...
        fid_o = fopen(strcat(path_out,files_out_proj1d_angles_list{1}(1:end-22-length(num2str(NSIDE))),'_NSIDE',num2str(NSIDE),'_half.bin'),'w');
...
%         fclose(fid_o);
        ...
        if level_window~=0
            ...
            fid_o = fopen(strcat(path_out,'level_window',mat2str(level_window(:)),'/',files_out_filtered_1dproj_angle_z_list{1}(1:end-22-length(num2str(NSIDE)),'_NSIDE',num2str(NSIDE),'_half.bin'),'w');
...
%             
            ...
            fid_o = fopen(strcat(path_out_all,'level_window',mat2str(level_window(:)),'/',files_filtered_1dproj_angle_z_list{1}(1:end-22-length(num2str(NSIDE)),'_NSIDE',num2str(NSIDE),'_half.bin'),'w');
